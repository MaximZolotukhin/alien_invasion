...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode((self.settings.screen_width,
                                               self.settings.screen_height))  # Создаем экран игры с указанныеми размерами (размер переадем кортежем)
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Проверка поподания в пришельцев.
        ...
        if not self.aliens:
            # Уничтожение существующийх снарядов и создание нового флота
            self.bullets.empty()
            self._create_fleet()
    ...
    def _update_screen(self):
        ...
        # Провериь, добрались ли пришельц до нижнего края экрана.
        self._check_aliens_bottom()

    def _create_fleet(self):
        """Создание флота вторжения."""
        # Создание пришельца и вычисление количества пришельцев в ряду.
        # Интревал между соседними пришельцами равен ширинет пришельца.
        alien = Alien(self)
    ...
    def _ship_hit(self):
        """Обробатывает столконовение коробля с пришельцем."""
        if self.stats.ships_left > 0:
            ...
            # Создание нового флота и размещение короблая в центре.
            self._create_fleet()
            self.ship.center_ship()
